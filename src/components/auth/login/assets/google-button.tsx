...
function SvgBtnGoogleDarkNormalIos(props: any) {
    return (
        <svg viewBox="0 0 46 46" {...props}>
            <defs>
                <rect
                    id="btn_google_dark_normal_ios_svg__b"
                    x={0}
                    y={0}
                    width={40}
                    height={40}
                ...
                />
                <rect
                    id="btn_google_dark_normal_ios_svg__c"
                    x={5}
                    y={5}
                    width={38}
                    height={38}
                ...
                <filter
                    ...
                    id="btn_google_dark_normal_ios_svg__a"
                >
                    <feOffset
                        dy={1}
                        in="SourceAlpha"
            ...
            <g fill="none" fillRule="evenodd">
                <g
                    ...
                    filter="url(#btn_google_dark_normal_ios_svg__a)"
                >
                    <use
                        fill="#4285F4"
                        xlinkHref="#btn_google_dark_normal_ios_svg__b"
                    />
                    <use xlinkHref="#btn_google_dark_normal_ios_svg__b" />
                    <use xlinkHref="#btn_google_dark_normal_ios_svg__b" />
                    <use xlinkHref="#btn_google_dark_normal_ios_svg__b" />
                </g>
                <g transform="translate(-1 -1)">
                    <use
                        fill="#FFF"
                        xlinkHref="#btn_google_dark_normal_ios_svg__c"
                    />
                    <use xlinkHref="#btn_google_dark_normal_ios_svg__c" />
                    <use xlinkHref="#btn_google_dark_normal_ios_svg__c" />
                    <use xlinkHref="#btn_google_dark_normal_ios_svg__c" />
                </g>
                <path
...
export default SvgBtnGoogleDarkNormalIos;
